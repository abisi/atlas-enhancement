...
def transplant_annotations(data_path, annotation_path, resolution):
    """
    Transplant pregenerated barrel annotations into the Allen annotation file.
    This does not make use of the template image volume.
    :param data_path: Path to barrel annotation file
    :param annotation_path: Path to Allen annotation file(s)
    :param resolution: Resolution identifier to determine which annotation file to use
    :return:
    """
    ...
    print('Saving updated annotation data to output path:', output_path)
